...
#use this command
# python tx_test0001.py -d A:0 -f 440e6 -r 1e6  -G 0.5 -P 0 -b 0 -l 1  /home/alex/digital_rf/python/examples/sounder/waveforms/code-l10000-b10-000000.bin --starttime 2019-07-02T13:05:00Z --duration 100 --nosync
