...
def wr_waveform_to_file(clen=400,dutycicle=50):
    a= create_code_test(clen=clen,dutycicle=dutycicle)

    name='code-%dkm-DC%d-wr.bin'% (clen*150/1000, dutycicle)
    print(name)
    a.tofile(name)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-d', '--dutycicle', type=int, default=50,
    ...
    wr_waveform_to_file(clen=op.length,dutycicle=op.dutycicle)
